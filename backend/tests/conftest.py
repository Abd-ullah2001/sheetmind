...
os.environ.setdefault("SUPABASE_ANON_KEY", "your-supabase-anon-key-placeholder")
os.environ.setdefault("SUPABASE_SERVICE_KEY", "your-supabase-service-key-placeholder")
